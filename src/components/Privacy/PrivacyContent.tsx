    ...
    return (
        <Wrapper>
            ...
            <div className="content">
                <div>상기 적용되는 범위의 서비스를 운영하고 있는 <b>아이엔랩 ienlab</b>은 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며 이용 목적이 변경되는 경우에는 「개인정보 보호법」 제18조에 따라 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다.
                </div>
                <div className={"box"}>
            ...
            <div className="content">
                <li>
                    <b>아이엔랩 ienlab</b>은 법령에 따른 개인정보 보유 · 이용기간 또는 정보주체로부터 개인정보를 수집 시에 동의받은 개인정보 보유 · 이용기간 내에서 개인정보를 처리 · 보유합니다.
                </li>
                <li>
            ...
            <div className="content">
                ...
                <li>
                    ...
                    <div className="box number">
                        <li>파기절차 : <b>아이엔랩 ienlab</b>은 파기 사유가 발생한 개인정보를 선정하고, <b>아이엔랩 ienlab</b>의 개인정보 보호책임자의 승인을 받아 개인정보를 파기합니다.
                        </li>
            ...
            <div className="content">
                ...
                <div className="box number">
                    ...
                    <li>제1항에 따른 권리 행사는 <b>아이엔랩 ienlab</b>에 대해 「개인정보 보호법」 시행령 제41조 제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며 <b>아이엔랩 ienlab</b>은 이에 대해 지체 없이 조치하겠습니다.
                    </li>
                    ...
                    <li>
                        <b>아이엔랩 ienlab</b>은 정보주체 권리에 따른 열람의 요구, 정정 · 삭제의 요구, 처리정지의 요구 시 열람 등 요구를 한 자가 본인이거나 정당한 대리인인지를 확인합니다.
                    </li>
                </div>
            </div>
            ...
            <div className="content">
                <b>아이엔랩 ienlab</b>은 온라인 맞춤형 광고 등을 위한 행태정보를 수집 · 이용 · 제공하지 않습니다.
            </div>
            <div className="title" id="chapter_9">09. {chapter[8]}</div>
            <div className="content">
                <div>
                    <b>아이엔랩 ienlab</b>은 ｢개인정보 보호법｣ 제15조 제3항 및 제17조 제4항에 따라 ｢개인정보 보호법 시행령｣ 제14조의2에 따른 사항을 고려하여 정보주체의 동의 없이 개인정보를 추가적으로 이용·제공할 수 있습니다.이에 따라 <b>아이엔랩 ienlab</b>이 정보주체의 동의 없이 추가적인 이용·제공을 하기 위해서 다음과 같은 사항을 고려하였습니다.
                </div>
                <div className="box">
            ...
            <div className="content">
                ...
                <li>정보주체께서는 <b>아이엔랩 ienlab</b>의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. <b>아이엔랩 ienlab</b>은 정보주체의 문의에 대해 지체 없이 답변 및 처리해 드릴 것입니다.
                </li>
            </div>
            <div className="title" id="chapter_11">11. {chapter[10]}</div>
            <div className="content">
                <div>정보주체는 ｢개인정보 보호법｣ 제35조에 따른 개인정보의 열람 청구를 아래의 부서에 할 수 있습니다. <b>아이엔랩 ienlab</b>은 정보주체의 개인정보 열람청구가 신속하게 처리되도록 노력하겠습니다.
                </div>
                <div className="box">
