...
export default function PrivacyContent({processPrivacy, company, name, charge, level, email, date}: PrivacyProps) {
    const chapter = [
    ...
    let connectWord = getCompleteWord(company, "은", "는");
    let connectWord2 = getCompleteWord(company, "이", "가");
        ...
        <Wrapper>
            ...
            <div className="content indices">
                {chapter.map((item, index) => (
                    <Link to={`chapter_${index + 1}`} smooth={true} offset={-90}>
            ...
            <div className="title" id={"chapter_1"}>01. {chapter[0]}</div>
            <div className="content">
                <div>상기 적용되는 범위의 서비스를 운영하고 있는 <b>{company}</b>{connectWord} 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며 이용 목적이 변경되는 경우에는 「개인정보 보호법」 제18조에 따라 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다.
                </div>
                <div className={"box"}>
                    <li>고객 가입의사 확인, 고객에 대한 서비스 제공에 따른 본인 식별 · 인증, 회원자격 유지 · 관리, 물품 또는 서비스 공급에 따른 금액 결제, 물품 또는 서비스의 공급 · 배송 등</li>
                </div>
            </div>
            <div className="title" id={"chapter_2"}>02. {chapter[1]}</div>
            <div className="content">
                <li>
            ...
            <div className="title" id="chapter_3">03. {chapter[2]}</div>
            <div className="content">
                <div><b>{company}</b>{connectWord} {
                    processPrivacy ? "다음의 개인정보 항목을 처리하고 있습니다." : "개인정보 항목을 처리하지 않습니다."
                }</div>
                {processPrivacy ? <div className="box">
            ...
            <div className="title" id="chapter_4">04. {chapter[3]}</div>
            <div className="content">
            ...
            <div className="title" id="chapter_5">05. {chapter[4]}</div>
            <div className="content">
            ...
            <div className="title" id="chapter_6">06. {chapter[5]}</div>
            <div className="content">
                ...
                <div className="box number">
                    ...
                    <li>개인정보에 대한 접근 제한<br/>개인정보를 처리하는 데이터베이스 시스템에 대한 접근권한의 부여, 변경, 말소를 통하여 개인정보에 대한 접근통제를 위하여 필요한 조치를 하고 있으며 침입차단 시스템을 이용하여 외부로부터의 무단 접근을 통제하고 있습니다.
                    </li>
                    <li>비인가자에 대한 출입 통제<br/>개인정보를 보관하고 있는 물리적 보관 장소를 별도로 두고 이에 대해 출입통제 절차를 수립, 운영하고 있습니다.</li>
                </div>
            </div>
            <div className="title" id="chapter_7">07. {chapter[6]}</div>
            <div className="content">
            ...
            <div className="title" id="chapter_8">08. {chapter[7]}</div>
            <div className="content">
                <b>{company}</b>{connectWord} 온라인 맞춤형 광고 등을 위한 행태정보를 수집 · 이용 · 제공하지 않습니다.
            </div>
            <div className="title" id="chapter_9">09. {chapter[8]}</div>
            <div className="content">
                <div>
                    <b>{company}</b>{connectWord} ｢개인정보 보호법｣ 제15조 제3항 및 제17조 제4항에 따라 ｢개인정보 보호법 시행령｣ 제14조의2에 따른 사항을 고려하여 정보주체의 동의 없이 개인정보를 추가적으로 이용·제공할 수 있습니다.이에 따라 <b>{company}</b>{connectWord2} 정보주체의 동의 없이 추가적인 이용·제공을 하기 위해서 다음과 같은 사항을 고려하였습니다.
                </div>
                <div className="box">
            ...
            <div className="title" id="chapter_10">10. {chapter[9]}</div>
            <div className="content">
                <li>
                    <b>{company}</b>{connectWord} 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.
                    <div className="box">
                        <h3>개인정보 보호책임자</h3>
                        <li>성명 : {name}</li>
                        <li>직책 : {charge}</li>
                ...
                <li>정보주체께서는 <b>{company}</b>의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. <b>{company}</b>{connectWord} 정보주체의 문의에 대해 지체 없이 답변 및 처리해 드릴 것입니다.
                </li>
            </div>
            <div className="title" id="chapter_11">11. {chapter[10]}</div>
            <div className="content">
                <div>정보주체는 ｢개인정보 보호법｣ 제35조에 따른 개인정보의 열람 청구를 아래의 부서에 할 수 있습니다. <b>{company}</b>{connectWord}정보주체의 개인정보 열람청구가 신속하게 처리되도록 노력하겠습니다.
                </div>
                <div className="box">
            ...
            <div className="title" id="chapter_12">12. {chapter[11]}</div>
            <div className="content">
                ...
                <div>「개인정보보호법」제35조(개인정보의 열람), 제36조(개인정보의 정정·삭제), 제37조(개인정보의 처리정지 등)의 규정에 의한 요구에 대하여 공공기관의 장이 행한 처분 또는 부작위로 인하여 권리 또는 이익의 침해를 받은 자는 행정심판법이 정하는 바에 따라 행정심판을 청구할 수 있습니다.<br/><br/>※ 행정심판에 대해 자세한 사항은 중앙행정심판위원회(www.simpan.go.kr) 홈페이지를 참고하시기 바랍니다.
                </div>
            </div>
            <div className="title" id="chapter_13">13. {chapter[12]}</div>
            <div className="content">
                이 개인정보 처리방침은 2024년 2월 22일부터 적용됩니다.
            </div>
        </Wrapper>
    );
}
